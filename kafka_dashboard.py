...
def job_schedule():
    ...
    schedule.every().minute.do(job, cur_headers=cur_headers, 
                                    cur_url=cur_url, 
                                    ago24h_headers=ago24h_headers, 
                                    ago24h_url=ago24h_url, 
                                    consumer_current=consumer_current, 
                                    consumer_24hAgo=consumer_24hAgo, 
                                    headers_dashboard=headers_dashboard,
                                    endpoint=endpoint,
                                    producer = producer)


def job(cur_headers, cur_url, ago24h_headers, ago24h_url, consumer_current, consumer_24hAgo, headers_dashboard,endpoint, producer):
    print("jobs start working at intervals")
...
if __name__ == "__main__":
    ...
    #you can replace the time with your desired time
    schedule.every().day.at("16:40:50").do(job_schedule)
